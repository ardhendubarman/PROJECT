...
f.save('CH4_adiabatic.xml', 'no_energy', 'solution with the energy equation disabled')
...
f.write_csv('CH4_adiabatic.csv', quiet=True)

#%%
z=f.grid
pkl.dump(z,open('data.pkl','wb'))
pkl.dump(f.T,open('temperature.pkl','wb'))
