...
ax2.set_xlim(-0.0006, 0.0006)
##ax2.set_ylim(-400000000, 400000000)
ax2.set_title("600K 5 bar",loc='right')
...
ax3.set_xlim(-0.0006, 0.0006)
ax3.locator_params(axis='y', nbins=10)
ax3.set_title("600K 8 bar", loc='right')
#plt.legend(frameon=False, handlelength = 5, fontsize=10)
ax3.set_xlabel('time [s]',fontsize='large')
ax3.locator_params(axis='x', nbins=4)

plt.savefig('fig15a.pdf',bbox_inches='tight')
plt.show()
